...
export const config = {
  ...
  quickLinks: [
    { name: "Gems Hospice", link: "https://gemshospice.com/" },
    { name: "MS Teams", link: "https://www.microsoft.com/en-us/microsoft-teams/group-chat-software" },
    { name: "Kaiser DB", link: "https://healthy.kaiserpermanente.org/front-door" },
    { name: "Email", link: "https://outlook.live.com" },
  ],
